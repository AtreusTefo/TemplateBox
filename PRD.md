...
* Exactly one passive banner per editor, selected by viewport: a 160x600 rail beside the workspace at 84rem and above, a 728x90 leaderboard above the workspace between 48rem and 84rem, or a 320x50 anchor fixed to the foot of the viewport below 48rem. The bands are mutually exclusive to the pixel: never two units, never none, never a second unit in any band.
